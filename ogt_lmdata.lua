...
k.sequentialScene = "levels.level" -- will turn into level1, level2, etc.
...
k.totalLevels = 5	-- total number of levels in the game. should equal (numCols * numRows) * numPages
...
k.numUnlocked = 10 -- how many of the first levels are unlocked (minimum 1)
