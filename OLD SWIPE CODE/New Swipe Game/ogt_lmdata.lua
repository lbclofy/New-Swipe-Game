...
name for each level you have.
	-- ==============================================================]]
k.playScene = "play" -- name of SB scene or nil to go to sequential scenes
...
k.totalLevels = 30	-- total number of levels in the game. should equal (numCols * numRows) * numPages
k.numCols = 5		 -- how many columns on each page of levels
k.numRows = 5		-- how many rows on each page of levels
